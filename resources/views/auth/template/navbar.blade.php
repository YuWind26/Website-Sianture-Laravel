<nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-fixed-top rounded-3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0 ms-auto">
            ...
            <li class="nav-item px-3">
                <a class="nav-link fs-6" aria-current="page" href="/profil">PROFIL</a>
            </li>
            <li class="nav-item px-3">
            ...
            @auth
                ...
                <li class="nav-item px-3 ">
                    <a class="nav-link fs-6 active" aria-current="page" href="/dashboard">ADMIN</a>
                </li>
            @else
                <li class="nav-item px-3 ">
                    <a class="nav-link fs-6 active" aria-current="page" href="/login">LOGIN</a>
                </li>
