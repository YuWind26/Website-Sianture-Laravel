...
@section('content')
    ...
    <a href="/kategori/create" class="btn btn-primary btn-sm "><i class="fas fa-plus mx-1"></i>Tambah Kategori</a>
            ...
            <tr>
                ...
                <td align="center" width="20%">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="/kategori/{{$row->id}}/edit" class="btn btn-primary btn-sm mr-1"><i class="fas fa-edit mx-1"></i>Update</a>
