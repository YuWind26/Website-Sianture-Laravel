...
@section('content')
    ...
    <a href="/post/create" class="btn btn-primary btn-sm "><i class="fas fa-plus mx-1"></i>Tambah post</a>
                ...
                <tr>
                    ...
                    <td align="center" width="30%">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="/post/{{$row->id}}" class="btn btn-info btn-sm mr-1"><i class="fas fa-eye mx-1"></i>Detail</a>
                            <a href="/post/{{$row->id}}/edit" class="btn btn-primary btn-sm mr-1"><i class="fas fa-edit mx-1"></i>Edit</a>
